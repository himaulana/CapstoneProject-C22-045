    ...
    <?php if(request()->get('search')): ?>
        <div class="container-xl text-base">
            <div class="row flex-lg-row-reverse align-items-center py-5">
                ...
                <form class="d-flex flex-row" method="get" action="<?php echo e(route('explore__search')); ?>">
                                        ...
                                        <div class="row">
                                            <?php $__currentLoopData = $search; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-sm-12 col-md-6 col-lg-4">
                                                    <a href="/plant/<?php echo e($item->id); ?>"
                                                        class="text-decoration-none text-base link-dark">
                                                        <div class="card rounded-5 card-plant mb-3 text-center">
                                                            <img src="<?php echo e($item->link_image); ?>.<?php echo e($item->id); ?>"
                                                                class="m-3" alt="">
                                                            <div class="card-body">
                                                                <h2 class="fw-semibold"><?php echo e($item->name); ?></h3>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
        ...
        <div class="container-xl text-base">
            <div class="row flex-lg-row-reverse align-items-center pb-5 pt-lg-">
                <div class="col-lg-7">
                    <img src="https://source.unsplash.com/random/200x200/?healthy,<?php echo e($item->id); ?>"
                        alt="Growing Plants" class="dblock mx-lg-auto img-fluid" width="700px">
                </div>
                <div class="col-12 col-lg-5 text-lg-start text-center">
                    <h2 class="fw-semibold fs-1 lh-sm mb-4 text-break"><?php echo e($article[0]->title); ?>

                    </h2>
                    <p class="fw-semibold text-wrap text-break"><?php echo e(Str::limit($article[0]->content, 300)); ?></p>
                    <button type="button" class="btn button-input mt-2 px-5 py-3 fw-semibold explore-button mb-4">
                        <a href="/article/<?php echo e($article[0]->id); ?>">Explore
                            Now</a>
                    </button>
                </div>
            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <h2 class="fw-semibold"><?php echo e($item->title); ?></h3>
                                                                <button type="button"
                                                                    ...
                                                                    <a href="/article/<?php echo e($item->id); ?>">Explore
                                                                        Now</a>
                                                                </button>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maulana\Documents\CapstoneProject-C22-045\resources\views/explore.blade.php ENDPATH**/ ?>