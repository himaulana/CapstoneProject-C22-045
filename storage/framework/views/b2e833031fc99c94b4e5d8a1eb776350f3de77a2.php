...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-xl text-base t-5 pt-5">
        <div class="row flex-lg-row align-items-center py-5">
            <div class="col-lg-7">
                <img src="<?php echo e(url('/images/about-image2.png')); ?>" alt="Growing Plants" class="dblock mx-lg-auto img-fluid"
                    width="1200px">
            </div>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4">
                                            <a href="/plant/<?php echo e($item->id); ?>"
                                                ...
                                                <div class="card rounded-5 card-plant mb-3 text-center">
                                                    <img src="<?php echo e($item->link_image); ?>.<?php echo e($item->id); ?>" class="m-3"
                                                        alt="">
                                                    <div class="card-body">
    ...
    <div class="container-xl text-base">
        <div class="row flex-lg-row-reverse align-items-center pb-5 pt-lg-">
            ...
            <div class="col-12 col-lg-5 text-lg-start text-center">
                <h2 class="fw-semibold fs-1 lh-sm mb-4 text-break"><?php echo e($article[0]->title); ?></h2>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maulana\Documents\CapstoneProject-C22-045\resources\views/home.blade.php ENDPATH**/ ?>